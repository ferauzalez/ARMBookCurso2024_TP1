...
![diagrama de módulos, funciones y variables se presenta a continuación](Curso ARMBook 2024 - Diagrama de modulos, funciones y variables.png)
...
![FSM Principal](Curso ARMBook 2024 - FSM Principal.png)
...
- Estos cambios tuvieron por objetivo refactorizar el código.[ En el video de demostración del presente trabajo](https://youtu.be/fCFSCCyr1Co) se observa un comportamiento similar al [correspondiente del TP1](https://youtu.be/J5sgj14au_0).
